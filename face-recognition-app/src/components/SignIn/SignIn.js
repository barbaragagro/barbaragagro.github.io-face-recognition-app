		...
		onSubmitSignIn = () => {
			...
			.then(user =>{
				if (user.id) {
				 ...
				 alert('Error. Check if you filled out all of the fields, if yes, then that email and/or password is not correct.');
				}
				}
			)
		...
		<main className="pa4 black-80">
		  <div className="measure ">
		    ...
		    <div className="lh-copy mt3">
		      <p onClick={()=>onRouteChangeS('register')} className="f6 pointer link dim black db">Register</p>
